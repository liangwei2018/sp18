...
public class LinkedListDequeTest {
    ...
    public static void addIsEmptySizeTest() {
        System.out.println("Running add/isEmpty/Size/deep copy/get() test.");
        ...
        passed = checkStringItem("front", lld1.get(0)) && passed;
        passed = checkStringItem("back", lld1.get(2)) && passed;
